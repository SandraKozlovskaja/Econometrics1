...
Mano ruletėje 3 spalvos: 18 juodos, 18 raudonos ir 1 žalia.
...
```{r}
n=1000
balansas <- replicate(n, sum(sample(c(-1,1), n, replace=TRUE, prob=c(19/37, 18/37)))) #1000 kartų sumuojami -1 ir +1 su tikimybe 19/37 ir 18/37 atitinkamai
